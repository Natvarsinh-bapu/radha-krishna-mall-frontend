import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///var/www/toy-store/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { getResponseStatusText, getResponseStatus, getQuery, createError, appendResponseHeader } from 'file:///var/www/toy-store/node_modules/h3/dist/index.mjs';
import { joinRelativeURL, joinURL, withoutTrailingSlash } from 'file:///var/www/toy-store/node_modules/ufo/dist/index.mjs';
...
import { renderToString } from 'file:///var/www/toy-store/node_modules/vue/server-renderer/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///var/www/toy-store/node_modules/unhead/dist/server.mjs';
import { stringify, uneval } from 'file:///var/www/toy-store/node_modules/devalue/index.js';
import { walkResolver } from 'file:///var/www/toy-store/node_modules/unhead/dist/utils.mjs';
import { toValue, isRef, hasInjectionContext, inject, ref, watchEffect, getCurrentInstance, onBeforeUnmount, onDeactivated, onActivated } from 'file:///var/www/toy-store/node_modules/vue/index.mjs';
